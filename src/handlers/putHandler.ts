...
export default async function putHandler({ ...properties }: SyfetchInterface): Promise<SyfetchResponseInterface> {
    try {
        ...
        console.error("Put handler error code put-handler-001: ", error);
